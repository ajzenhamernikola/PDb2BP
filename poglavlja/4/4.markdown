...
int main()
{
    ...
    EXEC SQL 
        BEGIN COMPOUND ATOMIC STATIC
            ...
            INSERT 
            INTO    ispitni_rok
            VALUES  (YEAR(CURRENT_DATE), 'maj', 'Maj ' || YEAR(CURRENT_DATE), CURRENT_DATE, CURRENT_DATE + 20 DAYS, 1);

            -- Druga naredba
            UPDATE  ISPITNI_ROK
            SET     KRAJ_PRIJAVLJIVANJA = KRAJ_PRIJAVLJIVANJA - 10 DAYS
            WHERE   GODINA = 2019 AND
                    OZNAKA = 'maj';
        END COMPOUND;
    is_error("Compound");
...
{% include zadatak.html broj="4.6" tekst="Napisati C/SQL program koji redom:\n
\n
