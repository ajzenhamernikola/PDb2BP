...
{% include zadatak.html broj="4.1" tekst="Napisati C/SQL program koji redom:\n
\n
...
{% include zadatak.html broj="4.2" tekst="Napisati C/SQL program koji redom:\n
\n
...
{% include zadatak.html broj="4.3" tekst="Napisati C/SQL program kojim se za svaki ispitni rok prvo ispisuju informacije o nazivu i godini roka, a zatim se korisnik pita da li želi da obriše sva polaganja za taj ispitni rok. Ukoliko želi, aplikacija izvršava brisanje i prikazuje poruku korisniku. Obrada jednog ispitnog roka predstavlja jednu transakciju." %}

Rešenje:

include_source(primeri/poglavlje_4/zadatak_4_3.sqc, c)

{% include zadatak.html broj="4.4" tekst="Napisati C/SQL program koji za svaki predmet koji nije obrađen izlistava njegov naziv i bodove. Korisniku se nudi opcija da poveća broj bodova za 1. Obrada 5 uzastopnih predmeta predstavlja jednu transakciju. Nakon svakog 5. predmeta pitati korisnika da li želi da nastavi sa daljim izmenama. Ukoliko ne želi, program se prekida. U suprotnom, nastaviti sa daljom obradom predmeta." %}
...
{% include zadatak.html broj="4.5" tekst="Napisati C/SQL program koji redom:\n
\n
...
include_source(primeri/poglavlje_4/zadatak_4_5.sqc, c)

Naredni zadatak ilustruje kompleksniji rad sa ta\v ckama \v cuvanja u okviru transakcija.

{% include zadatak.html broj="4.6" tekst="Napisati C/SQL program kojim se omogu\'cuje da radnik u studentskoj slu\v zbi poni\v stava studentske ispite. Obrada jednog studenta u jednoj godini roka, koja je opisana u nastavku, mora da predstavlja zasebnu transakciju. Transakcija se sastoji od narednih koraka:\n
\n
...
{% include izlaz.html datoteka="4.6.txt" %}
...
include_source(primeri/poglavlje_4/zadatak_4_6.sqc, c)

## 4.6 Zadaci za vežbu

{% include zadatak.html broj="4.7" tekst="Napisati C/SQL program koji redom:\n
\n
...
{% include zadatak.html broj="4.8" tekst="Napisati C/SQL program koji redom:\n
\n
1. Kreira novi ispitni rok samo za predmete iz prvog semestra u 2019. godini čija je oznaka `'apr'` i naziv `'April 2019'`. Za početak prijavljivanja postaviti današnji datum i postaviti da prijavljivanje traje 10 dana.\n
2. Ažurira tip za prethodno uneti ispitni rok na tip `'Z'`. \n
\n
