...
{% include zadatak.html broj="10.2" tekst="Dopuniti prethodni zadatak tako da implementira brisanje podataka o prethodno unetom smeru iz tabele `SMER`." %}
...
include(primeri/poglavlje_10/src/zadatak_10_2/Main.java, java)
...
{% include zadatak.html broj="10.3" tekst="Dopuniti prethodni zadatak tako da implementira unos podataka o novom ispitnom roku (jun 2019. godine) u tabelu `ISPITNI_ROK`." %}
...
include(primeri/poglavlje_10/src/zadatak_10_3/IspitniRokId.java, java)

Zatim je potrebno specifikovati instancu ove klase kao primarni ključ klase `IspitniRok.java`, 
koju takođe kreiramo:

include(primeri/poglavlje_10/src/zadatak_10_3/IspitniRok.java, java)

Definisane klase se sada jednostavno koriste u metodu `insertIspitniRok()` proširene klase
`Main.java` iz prethodnog primera:

include(primeri/poglavlje_10/src/zadatak_10_3/Main.java, java)

Ne zaboravimo da dodamo `IspitniRok` kao anotiranu klasu u konfiguraciju:

include(primeri/poglavlje_10/src/zadatak_10_3/HibernateUtil.java, java)

{% include zadatak.html broj="10.4" tekst="Dopuniti prethodni zadatak tako da implementira brisanje prethodno unetog ispitnog toka iz tabele `ISPITNI_ROK`." %}
...
include(primeri/poglavlje_10/src/zadatak_10_4/HibernateUtil.java, java)
