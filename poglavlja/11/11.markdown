...
{% include zadatak.html broj="11.2" tekst="Napisati Java aplikaciju koja kori\v s\'cenjem biblioteke Hibernate ispisuje podatke o ispitnom roku \v cija se oznaka i godina unose sa standardnog ulaza." %}
