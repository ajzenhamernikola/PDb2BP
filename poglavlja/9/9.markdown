...
include_source(primeri/poglavlje_9/src/zadatak_9_2/Main.java)

## 9.? Zadaci za ve\v zbu

{% include zadatak.html broj="9.3" tekst="Napisati Java program u kojem se SQL naredbe izvr\v savaju dinami\v cki koji za sve ispitne rokove pronalazi
...
{% include zadatak.html broj="9.4" tekst="Napisati Java program u kojem se SQL naredbe izvr\v savaju dinami\v cki koji redom:\n
\n
