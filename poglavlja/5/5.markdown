...
int main()
{
    ...
    EXEC SQL DECLARE predmeti CURSOR WITH HOLD FOR 
        SELECT 
            ID_PREDMETA, 
            SIFRA, 
            NAZIV, 
        ...
        if (odgovor_od_korisnika == 'd' || odgovor_od_korisnika == 'D')
        {
            ...
            EXEC SQL 
                UPDATE 
                    PREDMET
                SET 
                    BROJ_SEMESTARA = :d_broj_semestara + 1
...
INSERT INTO 
    ISPITNI_ROK 
VALUES
    (2016, 'Jan2016', 'Januar 2016', '01/01/2016', '01/12/2016', '1'),
...
int main()
{
    ...
    for(; i<3; ++i)
    {
        ...
        for(;;)
        {
            EXEC SQL FETCH ispitniRok 
                INTO :godina, :oznaka, :naziv;
            is_error("Fetch");
...
int main()
{
    ...
    for(;;)
    {
        EXEC SQL INSERT INTO ispitni_rok
...
int main()
{
    ...
    for(; i<3; ++i)
    {
        ...
        {
            EXEC SQL FETCH ispitniRok 
                INTO :godina, :oznaka, :naziv, :pocetak, :kraj;
            is_error("Fetch");
...
int main()
{
    ...
    EXEC SQL DECLARE c_smer CURSOR FOR 
        SELECT id_smera, oznaka, naziv, semestara, bodovi 
        FROM smer;
    is_error("Declare cursor");
    ...
    for(;;)
    {
        EXEC SQL FETCH c_smer
            INTO :d_id, :d_oznaka, :d_naziv, :d_semestara, :d_bodovi;
